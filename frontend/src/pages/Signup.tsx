                ...
                <div className="flex flex-col w-full gap-2"> {/* Login information */}
                    <div className="flex flex-col p-4">
                        <div className="flex flex-col w-full h-fit gap-2">
                            <input className="text-gray-900 w-full h-10 border-1 border-gray-600 pl-2" type="text" placeholder="Username" />
                            <input className="text-gray-900 w-full h-10 border-1 border-gray-600 pl-2" type="text"  placeholder="Email" />
                            <input className="text-gray-900 w-full h-10 border-1 border-gray-600 pl-2" type="text"  placeholder="Password" />
                        </div>
                    </div>
                    <div className="flex flex-row justify-between pl-10 pr-10">
                        <div className="flex flex-row gap-4 items-center">
                            <h3 className="text-xs text-gray-800">Already hava an account ?</h3>
                            {/* <Link to='/signup' /> */}
                        </div>
                    </div>
